...
fun GestureAction.labelRes(): Int = when (this) {
    GestureAction.ADD_TO_QUEUE -> R.string.sys_gesture_action_add_to_queue
    GestureAction.PLAY_NEXT -> R.string.sys_gesture_action_play_next
    GestureAction.START_RADIO -> R.string.start_radio
    GestureAction.ADD_TO_PLAYLIST -> R.string.sys_gesture_action_add_to_playlist
    GestureAction.ADD_TO_FAVORITE -> R.string.sys_gesture_action_add_to_favorites
    GestureAction.SHOW_TRACK_INFO -> R.string.sys_gesture_action_show_track_info
    GestureAction.NONE -> R.string.sys_gesture_action_none
}
...
@StringRes
fun GestureTrigger.labelRes(): Int = when (this) {
    GestureTrigger.SwipeStart -> R.string.sys_gesture_trigger_swipe_start
    GestureTrigger.SwipeEnd -> R.string.sys_gesture_trigger_swipe_end
    GestureTrigger.LongPress -> R.string.sys_gesture_trigger_long_press
}

@StringRes
fun Side.labelRes(): Int = when (this) {
    Side.Start -> R.string.sys_gesture_side_start
    Side.End -> R.string.sys_gesture_side_end
}
            ...
            val icon: @Composable BoxScope.() -> Unit = {
                when (s.action) {
                    ...
                    GestureAction.ADD_TO_FAVORITE -> Icon(
                        ...
                        contentDescription = stringResource(
                            if (isFavorited) R.string.sys_gesture_action_remove_from_favorites
                            else R.string.sys_gesture_action_add_to_favorites
                        ),
                        modifier = Modifier.fillMaxSize(),
                        tint = Color.White,
